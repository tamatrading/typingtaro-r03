      ...
      <div className="w-full max-w-2xl p-8 bg-gradient-to-b from-blue-100 to-blue-200 shadow-xl rounded-lg transition-transform duration-300 hover:scale-[1.02]">
        <div className="text-center mb-4">
          <div className="flex justify-between items-center mb-2">
            ...
            <h1 className="text-2xl font-bold">typingTaro r03</h1>
        ...
        >
          ...
          {showSuccessEffect && (
            <div className="absolute inset-0 pointer-events-none">
              <div className="absolute inset-0 bg-white/20 animate-[success-flash_0.5s_ease-out_forwards]"></div>
              <div className="absolute inset-0 border-4 border-white/40 rounded-lg animate-[success-ring_0.5s_ease-out_forwards]"></div>
            </div>
          )}
        </div>
